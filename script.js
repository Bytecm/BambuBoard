...
async function getFrontendConfig() {
    try {
        const response = await fetch('http://' + serverURL + ':3000/get-frontend-config', {
            method: 'GET',
        ...
        useFahrenheit = JSON.parse(data.useFahrenheit);
        use12HourFormat = JSON.parse(data.use12HourFormat);
        consoleLogging = JSON.parse(data.consoleLogging);
